import { customElement, property, html } from '../lit';
import { AMElement, AMItem } from '../base';
import { AmButton } from './am-button';
const itemGroups = require('@data/works');


@customElement('am-content-item')
export class AMContentItem extends AmButton
{
...
@customElement('am-content-switcher')
export class AMContentSwitcher extends AMElement
{
